...
<div  class="container-fluid" id="formCreate" style=""> 
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
            <h2 class=""> Informations de l'étudiant </h2>
        </div>
        ...
        <div class="col-xs-6 col-sm-6 col-md-5 col-lg-5 " style="margin-top:5%;">
            <div class="custom-file">
                <input id="phtoSelect" type="file" class="" name="img" >
                <label id="nomPhoto" class="" >importer photo</label>
            </div>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12  ">
        ...
        <span>Numéro Apogee : </span><input type="number" id="numApogee" placeholder="numéro apogee" value="<?=$numApo?>" name="numApogee" style="width:16%;"
                        min="0" max="100000">
...
?>
        ...
        <div class="md-form conteneurInputEtud" >
            ...
            <select name="selectGroupe" class="browser-default custom-select col-xs-12 col-sm-6 col-md-6 col-lg-6">
