...
<form class="text-center bg-white border border-light p-5 w-50 mx-auto rounded-sm" action="index.php?module=etudiant&action=connexionResponsable" id="formConnect" method="POST">
